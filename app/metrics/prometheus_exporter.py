...
TRADES_COUNTER = Counter('trading_bot_trades_total', 'Total number of trades', ['strategy', 'exchange', 'result'])
PROFIT_GAUGE = Gauge('trading_bot_profit_total', 'Total profit/loss', ['strategy', 'exchange'])
POSITION_GAUGE = Gauge('trading_bot_positions_open', 'Number of open positions', ['strategy', 'exchange'])
...
API_REQUESTS = Counter('trading_bot_api_requests', 'API requests', ['exchange', 'endpoint', 'status'])
...
class GrafanaDashboard(BaseModel):
    ...
    def _trades_panel(self) -> Dict:
        ...
        return {
            ...
            "type": "stat",
            "targets": [{
                "expr": "sum(rate(trading_bot_trades_total[5m]))",
    ...
    def _positions_panel(self) -> Dict:
        ...
        return {
            ...
            "type": "gauge",
            "targets": [{
                "expr": "sum(trading_bot_positions_open)",
    ...
    def _errors_panel(self) -> Dict:
        ...
        return {
            ...
            "type": "graph",
            "targets": [{
                "expr": "rate(trading_bot_errors_total[5m])",
