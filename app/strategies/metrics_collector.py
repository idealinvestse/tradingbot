...
class MetricsCollector:
    ...
    def record_signal(self, strategy_name: str, signal: Dict[str, Any], correlation_id: str) -> None:
        ...
        logger.info(f"Signal recorded for {strategy_name}", extra={"correlation_id": correlation_id})
