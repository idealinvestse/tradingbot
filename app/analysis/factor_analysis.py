...
class FactorAnalyzer:
    ...
    def run_pca(self) -> Tuple[np.ndarray, np.ndarray]:
        ...
        factor_data = pd.DataFrame({
            name: factor.data for name, factor in self.factors.items()
        })
...
class FactorRotation:
    ...
    def calculate_factor_score(self, factor_values: Dict[str, float],
    ...
    def generate_signals(self, factor_scores: pd.Series, 
