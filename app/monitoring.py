...
class PerformanceMonitor:
    ...
    def monitor_backtest(self, strategy: str, timerange: str) -> Dict[str, Any]:
        ...
        def on_complete(success: bool, metrics: Optional[Dict] = None):
            ...
            if success:
                ...
                if metrics:
                    self.collector.set_gauge(f"backtest.profit.{strategy}", metrics.get("profit_total", 0))
                    self.collector.set_gauge(f"backtest.trades.{strategy}", metrics.get("trades", 0))
            else:
    ...
    def monitor_live_trading(self, strategy: str) -> None:
        ...
        def on_trade(trade_result: Dict):
            ...
            self.collector.set_gauge(
                f"live.pnl.{strategy}",
                trade_result.get("total_profit", 0)
            )
